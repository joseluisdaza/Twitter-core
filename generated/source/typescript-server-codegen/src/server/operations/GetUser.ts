...
export type GetUserErrors = NotFoundError | UnauthorizedError | InternalServerError

export class GetUserSerializer implements __OperationSerializer<ChirpServiceService<any>, "GetUser", GetUserErrors> {
  ...
  isOperationError(error: any): error is GetUserErrors {
    const names: GetUserErrors['name'][] = ["NotFoundError", "UnauthorizedError", "InternalServerError"];
...
export class GetUserHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly mux: __Mux<"ChirpService", "GetUser">;
  private readonly serializer: __OperationSerializer<ChirpServiceService<Context>, "GetUser", GetUserErrors>;
  ...
  constructor(
    ...
    mux: __Mux<"ChirpService", "GetUser">,
    serializer: __OperationSerializer<ChirpServiceService<Context>, "GetUser", GetUserErrors>,
    serializeFrameworkException: (e: __SmithyFrameworkException, ctx: __ServerSerdeContext) => Promise<__HttpResponse>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match com.chirp.api#ChirpService.GetUser. This indicates a misconfiguration.');
